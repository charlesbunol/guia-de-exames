...
const baseExamsData = [
  ...
  },
  {
    ...
    category: 'Microbiologia',
    synonyms: ['Swab Vaginal', 'Cultura de Conteúdo Vaginal', 'Cultura de Fundo de Saco', 'Exame Direto de Secreção Vaginal', 'Bacterioscopia Vaginal', 'Pesquisa a Fresco'],
  ...
  },
  {
    ...
    category: 'Sorologia',
    synonyms: ['Anti-HIV 1 e 2', 'Teste de Quarta Geração HIV', 'Sorologia HIV'],
